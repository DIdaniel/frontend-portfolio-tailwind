  ...
  <div className="bg-blue-900 h-1 w-20 mx-auto mb-10"></div>
    <section className="sm:grid sm:grid-cols-2 sm:gap-3 lg:max-w-7xl lg:mx-auto pb-10">
      <div className="relative">
        ...
        <button className="absolute right-12 bottom-3 bg-white py-2 px-4 flex items-center">Click Me<FaArrowRight className="ml-3" /></button>
      </div>
      ...
      <div className="relative mt-5 sm:mt-0">
        ...
        <h4 className="absolute top-10 right-12 bg-black text-white py-2 px-3">Moving 3D Card</h4>
        <FiPlayCircle className="absolute bottom-5 text-7xl text-white left-5"/>
      </div>
      <div className="relative">
        <img src={grid4} alt="grid1" />
        <button className="absolute right-12 bottom-5 bg-white py-2 px-4 flex items-center">Click Me<FaArrowRight className="ml-3" /></button>
      </div>
    </section>
    </>
  )
